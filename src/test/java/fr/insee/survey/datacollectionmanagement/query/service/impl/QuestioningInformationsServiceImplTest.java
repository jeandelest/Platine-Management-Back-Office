...
class QuestioningInformationsServiceImplTest {
    ...
    public void testGetFormattedCivility_Male() {
    ...
    public void testGetFormattedCivility_Female() {
    ...
    public void testGetFormattedCivility_NoGender() {
    ...
    public void testGetFormattedCivility_NoFirstName() {
    ...
    public void testGetFormattedCivility_NoLastName() {
    ...
    public void testGetFormattedCivility_NoGenderAndFirstName() {
    ...
    public void testGetFormattedCivility_NoGenderAndLastName() {
    ...
    public void testGetFormattedCivility_NoNames() {
    ...
    public void testGetFormattedCivility_EmptyStrings() {
    ...
    public void testGetFormattedCivility_TrimmedInputs() {
        String result = QuestioningInformationsServiceImpl.getFormattedCivility("Male", " John ", " Doe ");
        assertEquals("M. John Doe", result);
    }
    ...
    public void testGetFormattedPhone_PrimaryPhone() {
    ...
    public void testGetFormattedPhone_NullPrimaryPhone() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
    ...
    public void testGetFormattedPhone_BlankPrimaryPhone() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
    ...
    public void testGetFormattedPhone_BothPhonesNull() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
    ...
    public void testGetFormattedPhone_BothPhonesBlank() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
    ...
    public void testGetFormattedPhone_BothPhonesNonBlank() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
        String result = service.getFormattedPhone("1234567890", "0987654321");
        assertEquals("1234567890", result);
    }
    ...
    public void testGetFormattedPhone_PrimaryNonBlankSecondaryBlank() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
    ...
    public void testGetFormattedPhone_PrimaryBlankSecondaryNonBlank() {
        QuestioningInformationsServiceImpl service = new QuestioningInformationsServiceImpl(null, null, null);
        String result = service.getFormattedPhone(" ", "0987654321");
        assertEquals("0987654321", result);
    }
