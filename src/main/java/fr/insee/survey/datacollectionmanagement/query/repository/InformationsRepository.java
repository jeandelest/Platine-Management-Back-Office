...
public class InformationsRepository {
    ...
    final static String GET_QUESTIONING_INFORMATIONS = """
            select
                c.identifier,
            	c.gender,
            	c.first_name,
    ...
    public QuestioningInformations findQuestioningInformations(String idCampaign, String idSu) {

        return jdbcTemplate.queryForObject(GET_QUESTIONING_INFORMATIONS, new BeanPropertyRowMapper<>(QuestioningInformations.class), idCampaign, idSu);
